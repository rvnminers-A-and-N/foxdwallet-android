...
import com.foxdwallet.presenter.activities.ManageAssetsActivity;
import com.foxdwallet.presenter.activities.UpdatePinActivity;
import com.foxdwallet.presenter.activities.util.BRActivity;
import com.foxdwallet.presenter.entities.BRSettingsItem;
...
import static com.foxdwallet.R.layout.settings_list_item;
import static com.foxdwallet.R.layout.settings_list_section;
...
//        }
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "com.com.foxdwallet"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "com.com.foxdwallet")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
